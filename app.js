...
function handleKey(e) {
  // Enter creates a new line. Sending only happens via the send button.
  // Intentionally left without preventDefault so default newline behavior applies.
}
...
function getMentorReply(userText) {
  var replies = [
    "That's a meaningful place to start. Tell me, what do you think is the root of this?",
    "Thank you for sharing that with me. When you imagine this resolved, what does that look like?",
...
function handleKey(e) {
  ...
  // User must tap the send button to send the message.
}
